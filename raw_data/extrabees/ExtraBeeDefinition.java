...
public enum ExtraBeeDefinition implements IBeeDefinition {
    ...
    DESOLATE(ExtraBeeBranchDefinition.BARREN, "desolo", false, new Color(0xd1b890), new Color(0xcbe374)) {
        ...
        protected void setAlleles(IAllele[] template) {
            ...
            AlleleHelper.getInstance().set(template, EnumBeeChromosome.EFFECT,
                    AlleleHelper.getAllele(ExtraBeesEffect.HUNGER.getUID()));
        }
    ...
    GNAWING(ExtraBeeBranchDefinition.BARREN, "apica", true, new Color(0xe874b0), new Color(0xcbe374)) {
        ...
        @Override
        protected void setAlleles(IAllele[] template) {
            AlleleHelper.getInstance().set(template, EnumBeeChromosome.FLOWER_PROVIDER,
    ...
    GRANITE(ExtraBeeBranchDefinition.ROCKY, "granum", true, new Color(0x695555), new Color(0x999999)) {
        ...
        @Override
        protected void setAlleles(IAllele[] template) {
            AlleleHelper.getInstance().set(template, EnumBeeChromosome.TEMPERATURE_TOLERANCE,
    ...
    LEAD(ExtraBeeBranchDefinition.METALLIC, "plumbous", true, new Color(0xad8bab), new Color(0x999999)) {
        ...
        protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
            beeSpecies
                    .addProduct(EnumHoneyComb.STONE.get(1), 0.20f)
                    .addSpecialty(EnumHoneyComb.LEAD.get(1), 0.05f);
        }
    ...
    RELIC(ExtraBeeBranchDefinition.HISTORIC, "sapiens", true, new Color(0x4d3e16), new Color(0xffdc16)) {
        ...
        protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
            beeSpecies
                    .addProduct(EnumHoneyComb.OLD.get(1), 0.30f)
                    .setHasEffect();
        }
    ...
    COAL(ExtraBeeBranchDefinition.FOSSILIZED, "carbo", true, new Color(0x7a7648), new Color(0xffdc16)) {
        ...
        protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
            beeSpecies
                    ...
                    .addSpecialty(EnumHoneyComb.COAL.get(1), 0.08f);
        }
    ...
    RESIN(ExtraBeeBranchDefinition.FOSSILIZED, "lacrima", false, new Color(0xa6731b), new Color(0xffdc16)) {
        ...
        protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
            beeSpecies
                    .addProduct(EnumHoneyComb.OLD.get(1), 0.20f)
                    .addSpecialty(EnumHoneyComb.RESIN.get(1), 0.05f);
        }
    ...
    RIVER(ExtraBeeBranchDefinition.AQUATIC, "flumen", true, new Color(0x83b3d4), new Color(0xffdc16)) {
        ...
        protected void registerMutations() {
            registerMutation(BeeDefinition.DILIGENT, WATER, 10)
                    .restrictBiomeType(BiomeDictionary.Type.RIVER);
        }
    },
    OCEAN(ExtraBeeBranchDefinition.AQUATIC, "mare", false, new Color(0x1d2ead), new Color(0xffdc16)) {
        ...
        protected void registerMutations() {
            registerMutation(BeeDefinition.DILIGENT, WATER, 10)
                    .restrictBiomeType(BiomeDictionary.Type.OCEAN);
        }
    },
    ...
    ALCOHOL(ExtraBeeBranchDefinition.FARMING, "vinum", false, new Color(0xe88a61), new Color(0xffdc16)) {
        ...
        protected void setAlleles(IAllele[] template) {
            AlleleHelper.getInstance().set(template, EnumBeeChromosome.EFFECT,
                    AlleleHelper.getAllele("forestry.effectDrunkard"));
        }
    ...
    SWAMP(BeeBranchDefinition.BOGGY, "paludis", true, new Color(0x356933), new Color(0xffdc16)) {
        ...
        protected void setAlleles(IAllele[] template) {
            AlleleHelper.getInstance().set(template, EnumBeeChromosome.EFFECT,
                    AlleleHelper.getAllele(ExtraBeesEffect.SLOW.getUID()));
        }
    ...
    ECSTATIC(ExtraBeeBranchDefinition.ENERGETIC, "ecstatica", true, new Color(0xaf35e8), new Color(0xffdc16)) {
        ...
        protected void setAlleles(IAllele[] template) {
            AlleleHelper.getInstance().set(template, EnumBeeChromosome.EFFECT,
                    AlleleHelper.getAllele(ExtraBeesEffect.POWER.getUID()));
        }
    ...
    ARTIC(BeeBranchDefinition.FROZEN, "artica", true, new Color(0xade0e0), new Color(0xdaf5f3)) {
        ...
        protected void setSpeciesProperties(IAlleleBeeSpeciesBuilder beeSpecies) {
            beeSpecies
                    .addProduct(ItemHoneyComb.VanillaComb.FROZEN.get(), 0.25f)
    ...
    ABYSS(ExtraBeeBranchDefinition.SHADOW, "abyssba", true, new Color(0x210821), new Color(0x333333)) {
        ...
        protected void setAlleles(IAllele[] template) {
            AlleleHelper.getInstance().set(template, EnumBeeChromosome.EFFECT,
                    AlleleHelper.getAllele(ExtraBeesEffect.WITHER.getUID()));
        }
    ...
    ExtraBeeDefinition(IBranchDefinition branch, String binomial, boolean dominant, Color primary, Color secondary) {
        ...
        this.branch = branch;
        if (branch != null) {
            this.speciesBuilder = new ExtraBeeSpecies(modId, uid, name, "Binnie", description, dominant,
                    branch.getBranch(), binomial, primary.getRGB(), secondary.getRGB());
        } else {
    ...
    public static void doInit() {
        ...
        registerMutation(ExtraBeeDefinition.WATER, ExtraBeeDefinition.MARBLE, BeeDefinition.COMMON, 15);
        registerMutation(ExtraBeeDefinition.ROCK, ExtraBeeDefinition.MARBLE, BeeDefinition.COMMON, 15);
        registerMutation(ExtraBeeDefinition.MARBLE, BeeDefinition.FOREST, BeeDefinition.COMMON, 15);
        registerMutation(ExtraBeeDefinition.MARBLE, BeeDefinition.MEADOWS, BeeDefinition.COMMON, 15);
        registerMutation(ExtraBeeDefinition.MARBLE, BeeDefinition.MODEST, BeeDefinition.COMMON, 15);
        registerMutation(ExtraBeeDefinition.MARBLE, BeeDefinition.TROPICAL, BeeDefinition.COMMON, 15);
        registerMutation(ExtraBeeDefinition.MARBLE, BeeDefinition.MARSHY, BeeDefinition.COMMON, 15);
        registerMutation(ExtraBeeDefinition.MARBLE, BeeDefinition.COMMON, BeeDefinition.CULTIVATED, 12);
    ...
    public IBeeMutationBuilder registerMutation(IBeeDefinition allele0, IBeeDefinition allele1, int chance) {
        return registerMutation(allele0.getGenome().getPrimary(), allele1.getGenome().getPrimary(), getTemplate(),
                chance);
    }

    public static IBeeMutationBuilder registerMutation(IBeeDefinition allele0, IBeeDefinition allele1,
            IBeeDefinition mutation, int chance) {
        return registerMutation(allele0.getGenome().getPrimary(), allele1.getGenome().getPrimary(),
                mutation.getTemplate(), chance);
    }

    public static IBeeMutationBuilder registerMutation(IAlleleBeeSpecies allele0, IAlleleBeeSpecies allele1,
            IAllele[] template, int chance) {
