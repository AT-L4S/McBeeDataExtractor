...
public class CareerBeeSpecies {
    ...
    // public static CustomBeeEntry CRAFTING = new CustomBeeEntry("crafting", false,
    // "crafting:crafticus", col(188, 150, 98), col(180, 119, 75))
    ...
    ;
    public static final CareerBeeEntry VOCATIONAL = new CareerBeeEntry("graduate", false, "consilium:graduati",
            col(60, 60, 80))
    ...
    public static final CareerBeeEntry BUISNESS = new CareerBeeEntry("buisnessman", false, "negotiator",
            col(40, 40, 40), col(80, 80, 80))
            .setCustomBeeModelProvider(new CustomBeeModel("tophat"))
            .setTemplateEffect(() -> EffectBuisness.INSTANCE);
    public static final CareerBeeEntry JUNK = new CareerBeeEntry("junk_seller", false, "negotiator", col(179, 89, 73),
            col(220, 170, 94))
            .setCustomBeeModelProvider(new CustomBeeModel("junk"))
            .setTemplateEffect(() -> EffectBuisness.JUNK);
    public static final CareerBeeEntry DIGGING_BASE = new CareerBeeEntry("digging", false, "digging:diggicus",
            col(222, 122, 20))
    ...
    public static final CareerBeeEntry DIGGING_FORTUNE = new CareerBeeEntry("digging.fortune", false,
            "digging:diggicus", col(175, 50, 20))
            .setTemplateAllelleBool(EnumBeeChromosome.CAVE_DWELLING, true)
            .setTemplateEffect(() -> EffectDigging.INSTANCE_FORTUNE)
            .setCustomBeeModelProvider(new CustomBeeModel("mining"));
    public static final CareerBeeEntry DIGGING_SILKY = new CareerBeeEntry("digging.silky", false, "digging:diggicus",
            col(122, 102, 200))
            .setTemplateAllelleBool(EnumBeeChromosome.CAVE_DWELLING, true)
            .setTemplateEffect(() -> EffectDigging.INSTANCE_SILKY)
            .setCustomBeeModelProvider(new CustomBeeModel("mining"));
    public static final CareerBeeEntry THIEF = new CareerBeeEntry("thief", false, "thief:cleptus", col(23, 23, 23),
            col(100, 100, 100))
            .setNocturnal()
            .setTemplateEffect(() -> EffectStealPlayer.PLAYER)
            .setCustomBeeModelProvider(new CustomBeeModel("thief"));
    public static final CareerBeeEntry POLICE = new CareerBeeEntry("police", false, "thief:cleptus", col(100, 140, 150),
            col(22, 67, 165))
            .setTemplateEffect(() -> EffectStealMob.MOB)
            .setCustomBeeModelProvider(new CustomBeeModel("police"));
    public static final CareerBeeEntry TAXCOLLECTOR = new CareerBeeEntry("taxcollector", false, "thief:cleptus",
            col(110, 110, 119), col(200, 200, 200))
            .setTemplateEffect(() -> EffectStealMobTaxation.INSTANCE)
            .setCustomBeeModelProvider(new CustomBeeModel("tax_collector"));
    public static final CareerBeeEntry ACCELERATION = new CareerBeeEntry("acceleration", false, "tempus:fugit",
            col(140, 50, 40))
    ...
    public static final CareerBeeEntry REPAIR = new CareerBeeEntry("repair", false, "smithing:faber",
            col(122, 122, 190), col(224, 210, 255))
            .setTemplateEffect(() -> EffectRepair.INSTANCE)
            .setCustomBeeModelProvider(new CustomBeeModel("hammer"));
    public static final CareerBeeEntry SHARPENER = new CareerBeeEntry("sharpening", false, "smithing:faber",
            col(200, 200, 200), col(120, 120, 120))
            .setTemplateEffect(() -> EffectSharpen.INSTANCE)
            .setCustomBeeModelProvider(new CustomBeeModel("hammer"));
    public static final CareerBeeEntry ARMORER = new CareerBeeEntry("armorer", false, "smithing:faber",
            col(100, 200, 200), col(100, 120, 120))
    ...
    public static final CareerBeeEntry HUSBANDRYIST = new CareerBeeEntry("husbandry", false, "medicus:easpariunt",
            col(122, 122, 190), col(224, 210, 255))
            .setTemplateEffect(() -> EffectHusbandry.INSTANCE)
            .setCustomBeeModelProvider(new CustomBeeModel("midwife"));
    public static final CareerBeeEntry BUTCHER = new CareerBeeEntry("butcher", false, "macello:caedes",
            col(250, 150, 150))
            .setTemplateEffect(() -> EffectButcher.INSTANCE)
            .setCustomBeeModelProvider(new CustomBeeModel("butcher"));
    public static final CareerBeeEntry WOMBLING = new CareerBeeEntry("collectors", false, "lectica:coactore",
            col(197, 60, 60))
    ...
    public static final CareerBeeEntry RAINBOW = new CareerBeeEntry("rainbow", false, "rain:eritque.arcus",
    ...
    public static final CareerBeeEntry DIRE = new CareerBeeEntry("dire", false, "dire", 0x00AFAF, 0xff463AA5)
            ...
            .setIsSecret();
    public static final CareerBeeEntry SOARYN = new CareerBeeEntry("soaring", false, "soaryn", col(0, 0, 16),
            col(80, 68, 99))
    ...
    public static final CareerBeeEntry SMELTER = new CareerBeeEntry("smelter", false, "smelter:smelter",
            col(81, 72, 64), col(109, 81, 53))
            .setCustomBeeModelProvider(new CustomBeeModel("smelter"))
            .setTemplateEffect(() -> EffectSmelt.INSTANCE);

    public static final CareerBeeEntry HONEY_SMELTER = new CareerBeeEntry("honey_smelter", false, "smelter:smelter",
            col(230, 160, 10), col(120, 50, 0))
            .setCustomBeeModelProvider(new CustomBeeModel("smelter"))
            .setTemplateEffect(() -> EffectHoneyCombIngotConvert.INSTANCE);

    public static final CareerBeeEntry ORE_CRUSHER = new CareerBeeEntry("crusher", false, "crusher:crusher",
            col(120, 120, 120), col(80, 80, 80))
    ...
    public static final CareerBeeEntry PLAGUE_DOCTOR = new CareerBeeEntry("plaguedoctor", false, "medicine",
            col(25, 25, 25), col(140, 140, 140))
    ...
    public static final CareerBeeEntry PHD = new CareerBeeEntry("phd", false, "consilium:graduati", col(160, 60, 80))
            .setTemplateEffect(() -> EffectEffection.INSTANCE)
            .setCustomBeeModelProvider(new CustomBeeModel("graduate"));
    public static final CareerBeeEntry CLOCKWORK = new CareerBeeEntry("clock", false, "clockwork", col(188, 181, 128),
            col(78, 70, 57))
            .setCustomBeeModelProvider(new CustomBeeModel("clockwork"))
            .setTemplateEffect(() -> EffectClockwork.INSTANCE);
    public static final CareerBeeEntry ENERGY = new CareerBeeEntry("energy", false, "redstoneflux", col(255, 0, 0),
            col(143, 0, 0))
    ...
    public static final CareerBeeEntry QUANTUM_CHARM = new CareerBeeEntry("quantum_charm", false, "science",
            col(255, 255, 255), col(0, 0, 0))
    ...
    public static final CareerBeeEntry QUANTUM_STRANGE = new CareerBeeEntry("quantum_strange", false, "science",
    ...
    public static final CareerBeeEntry MAD_SCIENTIST = new CareerBeeEntry("mad_scientist", false, "science",
            col(84, 121, 132))
            .setCustomBeeModelProvider(new CustomBeeModel("mad_scientist"))
            .setTemplateEffect(() -> EffectExplosion.INSTANCE);

    public static final CareerBeeEntry BENSEN = new CareerBeeEntry("bensen", true, "jazz", col(255, 255, 255),
            col(94, 46, 24))
            .setCustomBeeModelProvider(new CustomBeeModel("bensen"))
            .setTemplateEffect(() -> EffectJazz.INSTANCE)
            .setIsSecret();
    // public static final CareerBeeEntry LIGHT = new CareerBeeEntry("light", true,
    // "glow", col(255,255,255))
    // .setCustomBeeModelProvider(new CustomBeeModel("glow"))
    // .setTemplateEffect(() -> EffectLumination.INSTANCE);

    public static final CareerBeeEntry ELECTRICIAN = new CareerBeeEntry("electrician", false, "lightning",
            col(255, 253, 234))
    ...
    public static final CareerBeeEntry ROBOT = new CareerBeeEntry("robot", false, "beepboop", col(70, 76, 81),
            col(151, 175, 200))
    ...
    public static final CareerBeeEntry NCA = new CareerBeeEntry("nca", false, "evil", col(91, 212, 75),
            col(26, 171, 25))
    ...
    public static void register() {
        ...
        Map<CareerBeeEntry, Integer> bee_complexity = sorted_bee_entries.stream().collect(
                Collectors.toMap(t -> t, s -> tree.getLeastParents(s).stream().mapToInt(Set::size).min().orElse(0)));
        Map<String, Double> bee_model_complexity = sorted_bee_entries.stream().collect(
                Collectors.groupingBy(
                        ...
                        Collectors.collectingAndThen(
                                ...
                                s -> s.stream().mapToInt(Integer::intValue).average()
        ...
        registeredSpecies.addAll(
                sorted_bee_entries.stream().map(t -> t.species).filter(Objects::nonNull).collect(Collectors.toSet()));
        ...
        PlayerSpawnHandler.registerBeeSpawn("rwtema", UUID.fromString("72DDAA05-7BBE-4AE2-9892-2C8D90EA0AD8"),
                ACCELERATION);
        ...
        if (BeeMod.deobf_folder) {
            ...
            List<IAllele> registeredAlleles = Lists
                    .newArrayList(AlleleManager.alleleRegistry.getRegisteredAlleles(EnumBeeChromosome.SPECIES));
            ...
            for (IAlleleBeeSpecies iAllele : (Collection<IAlleleBeeSpecies>) ((Collection) registeredAlleles)) {
                ...
                for (int i = 0; i < EnumBeeChromosome.values().length; i++) {
                    ...
                    HashMap<String, String> abbreviate = StringHelper.abbreviate(AlleleManager.alleleRegistry
                            .getRegisteredAlleles(chromosome).stream().map(IAllele::getAlleleName)::iterator);
        ...
        if (BeeMod.deobf_folder) {
            BeeMod.logger.info(sorted_bee_entries.stream().map(CareerBeeEntry::get).map(IAllele::getAlleleName)
            ...
            BeeMod.logger.info(sorted_bee_entries.stream().map(c -> {
                ...
                String mutationString = paths.stream().map(
                        t2 -> {
                            ...
                            return s + " "
                                    + t2.getSpecialConditions().stream().collect(Collectors.joining(", ", "(", ")"));
                        }
                ...
                if (effectBase != null) {
                    s = s + "\n" + effectBase.getAlleleName() + ": "
                            + I18n.format(effectBase.getUnlocalizedName() + ".desc");
                }
    ...
    public static void buildMutationList() {
        ...
        tree.add(VOCATIONAL, VOCATIONAL, ARMORER, 0.1, v -> v
                .requireResource(Blocks.ANVIL.getBlockState().getValidStates().stream().toArray(IBlockState[]::new)));
        ...
        tree.add(VOCATIONAL, getFSpecies("Modest"), SMELTER, 0.5,
                v -> v.requireResource(BlockStateList.of(Blocks.FURNACE, Blocks.LIT_FURNACE)));
        ...
        tree.add(SCIENTIST, ENGINEER, MAD_SCIENTIST, 1, iBeeMutationBuilder -> iBeeMutationBuilder
                .addMutationCondition(new MutationRecentExplosion().forceMutation(MAD_SCIENTIST)));
    ...
    public static IMutationBuilder register(@Nonnull IAlleleBeeSpecies inA, @Nonnull IAlleleBeeSpecies inB,
            @Nonnull IAlleleBeeSpecies out, int chance) {
